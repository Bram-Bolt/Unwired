...
client.on('ready', () => {
  ...
  client.user.setActivity(serverInfo.ip);
...
client.on("message", message => {
  ...
  if (message.content === "hoogenboss music starts playing"){
    message.member.roles.add("802684145775411280");
  }
  //negeer dm berichten
  if (message.guild === null) {
    return message.reply("Je kunt mijn commands alleen gebruiken in de " + serverInfo.serverNaam + " discord!");
  }
  ...
  if(command === 'tiktok'){
    client.commands.get('tiktok').execute(message, args, Discord, client, config, serverInfo, fetch);
  }
